            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="pt-6 border-t border-white/5">
                    <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest leading-loose">
                        Check if <span className="text-white">NEXT_PUBLIC_SUPABASE_URL</span> and <span className="text-white">NEXT_PUBLIC_SUPABASE_ANON_KEY</span> are set in your environment.
                    </p>
                </div>
            </div>
        </div>
...
export default function AuthErrorPage() {
    return (
        <div className="min-h-screen bg-[#0A0A0B] text-white flex flex-col items-center justify-center p-6 font-sans">
            <Suspense fallback={<div className="text-gold animate-pulse font-black uppercase tracking-widest text-xs">Loading Error Context...</div>}>
                <AuthErrorContent />
            </Suspense>
        </div>
    );
